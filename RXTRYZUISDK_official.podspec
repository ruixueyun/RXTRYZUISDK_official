...
Pod::Spec.new do |s|
  s.name             = 'RXTRYZUISDK_official'
  s.version          = '1.0.0'
  s.summary          = 'ruixue RXTRYZUISDK_official framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXTRYZUISDK_official'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXTRYZUISDK_official.git', :tag => s.version.to_s }
